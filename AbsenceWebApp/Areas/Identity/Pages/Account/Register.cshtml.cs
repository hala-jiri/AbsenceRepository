...
namespace AbsenceWebApp.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    // if our roles doesnt exist yet
                    if (!await _roleManager.RoleExistsAsync(StaticDetails.EmployeeUser))
                    {
                        await _roleManager.CreateAsync(new IdentityRole(StaticDetails.EmployeeUser));
                    }
